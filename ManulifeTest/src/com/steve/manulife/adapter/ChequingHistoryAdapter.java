...
public class ChequingHistoryAdapter extends BaseAdapter{
	private LayoutInflater mInflater;
	private Context mContext;
	private ArrayList<com.steve.manulife.data.Activity> activities;
	public ChequingHistoryAdapter(Context mContext, ArrayList<com.steve.manulife.data.Activity> activities) {
