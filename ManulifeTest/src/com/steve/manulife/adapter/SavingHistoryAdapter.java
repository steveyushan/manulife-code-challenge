...
public class SavingHistoryAdapter extends BaseAdapter{
	private LayoutInflater mInflater;
	private Context mContext;
	private ArrayList<com.steve.manulife.data.Activity> activities;
	public SavingHistoryAdapter(Context mContext, ArrayList<com.steve.manulife.data.Activity> activities) {
